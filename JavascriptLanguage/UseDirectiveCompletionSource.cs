...
{
    internal class UseDirectiveCompletionSource : StringCompletionSource
    {
        private static readonly ImageSource _glyph = GlyphService.GetGlyph(
            Intel.StandardGlyphGroup.GlyphGroupIntrinsic, Intel.StandardGlyphItem.GlyphItemPublic);
        ...
        private static bool ConsumeToToken(IEnumerator<ClassificationSpan> enumerator, string token,
        ...
        /// <summary>
        ///     Consumes any comment tokens from a classification enumerator, until it rests at a non-comment token or at the
        ///     end.
        /// </summary>
